...
/**
 * Servlet que obtiene la bandeja de salida
 * @author arturv
 */
public class MensajesEnviados extends HttpServlet {
@EJB
     MsgBean miDao;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Se leen y mandan al jsp los mensajes de la bandeja de salida
        List<Message> mensajes = miDao.getMensajesEnviados(usuario);
